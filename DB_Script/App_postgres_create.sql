...
CREATE TABLE user_destination_visited (
	...
	Visited_By varchar(25) NOT NULL,
...
ALTER TABLE Post_Details ADD CONSTRAINT Post_Details_fk0 FOREIGN KEY (Created_By) REFERENCES User_Details(username);
ALTER TABLE Post_Details ADD CONSTRAINT Post_Details_fk1 FOREIGN KEY (Updated_By) REFERENCES User_Details(username);
...
ALTER TABLE User_Destination_Visited ADD CONSTRAINT User_Destination_Visited_fk1 FOREIGN KEY (Visited_By) REFERENCES User_Details(username);
